...
export default function SignupPage() {
  ...
  const inputStyle = (hasErr: boolean): React.CSSProperties => ({
    ...
    borderRadius: 12, fontSize: '14px', fontWeight: 600,
    ...
    <div style={{
      ...
      <div style={{
        ...
        <Link href="/login" style={{
          ...
          marginBottom: '1.5rem', color: 'rgba(148,163,184,0.7)', fontSize: '12.5px', fontWeight: 700,
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: '1.75rem' }}>
          ...
          <div>
            <h2 style={{ fontSize: '20px', fontWeight: 900, color: 'white', letterSpacing: '-0.02em', marginBottom: 3 }}>
              회원가입
            </h2>
            <p style={{ fontSize: '12.5px', color: 'rgba(148,163,184,0.7)', fontWeight: 500 }}>
              ProductPRO 계정을 만드세요
            </p>
          </div>
        </div>
        ...
        {done ? (
          <div style={{ textAlign: 'center', padding: '1.5rem 0' }}>
            ...
            <h3 style={{ fontSize: '17px', fontWeight: 800, color: 'white', marginBottom: 8 }}>가입 완료!</h3>
            <p style={{ fontSize: '13px', color: 'rgba(148,163,184,0.75)', lineHeight: 1.7, marginBottom: '1.75rem' }}>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
            ...
            {/* 이름 */}
            <div>
              <label style={{ display: 'flex', alignItems: 'center', gap: 5, fontSize: '12px', fontWeight: 700, color: 'rgba(148,163,184,0.8)', marginBottom: 6 }}>
                <User size={11} /> 이름
              </label>
              <input
              ...
              />
              {errors.name && <p style={{ fontSize: '11.5px', color: '#f87171', marginTop: 5, fontWeight: 600 }}>⚠ {errors.name}</p>}
            </div>
            ...
            <div>
              ...
              />
              {errors.id && <p style={{ fontSize: '11.5px', color: '#f87171', marginTop: 5, fontWeight: 600 }}>⚠ {errors.id}</p>}
            </div>

            {/* 이메일 (선택) */}
            <div>
              <label style={{ display: 'flex', alignItems: 'center', gap: 5, fontSize: '12px', fontWeight: 700, color: 'rgba(148,163,184,0.8)', marginBottom: 6 }}>
                <Mail size={11} /> 이메일 <span style={{ fontSize: '10.5px', fontWeight: 500, color: 'rgba(100,116,139,0.65)' }}>(선택)</span>
              </label>
              <input
              ...
              />
              {errors.email && <p style={{ fontSize: '11.5px', color: '#f87171', marginTop: 5, fontWeight: 600 }}>⚠ {errors.email}</p>}
            </div>
            ...
            <div>
              ...
              {errors.pw && <p style={{ fontSize: '11.5px', color: '#f87171', marginTop: 5, fontWeight: 600 }}>⚠ {errors.pw}</p>}
            </div>
            ...
            <div>
              ...
              {errors.pwConfirm && <p style={{ fontSize: '11.5px', color: '#f87171', marginTop: 5, fontWeight: 600 }}>⚠ {errors.pwConfirm}</p>}
              {form.pw && form.pwConfirm && !errors.pwConfirm && form.pw === form.pwConfirm && (
                <p style={{ fontSize: '11.5px', color: '#34d399', marginTop: 5, fontWeight: 600, display: 'flex', alignItems: 'center', gap: 4 }}>
            ...
            <p style={{ textAlign: 'center', fontSize: '12.5px', color: 'rgba(100,116,139,0.75)', marginTop: 2 }}>
              이미 계정이 있으신가요?{' '}
