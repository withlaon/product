    ...
    <div style={{
      ...
      <div className="hidden lg:flex" style={{
        ...
        <div style={{ textAlign: 'center' }}>
          ...
          <h1 style={{ fontSize: '32px', fontWeight: 900, color: 'white', letterSpacing: '-0.03em', marginBottom: 8 }}>
            ProductPRO
          </h1>
          <p style={{ fontSize: '13px', color: 'rgba(148,163,184,0.9)', letterSpacing: '0.15em', textTransform: 'uppercase', fontWeight: 700 }}>
            상품 통합 관리 시스템
          </p>
        </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16, width: '100%', maxWidth: 320 }}>
          {[
            ...
            <div key={f.text} style={{
              ...
              <span style={{ fontSize: '13.5px', fontWeight: 600, color: 'rgba(255,255,255,0.75)' }}>{f.text}</span>
            </div>
          ))}
        </div>

        <p style={{ fontSize: '11.5px', color: 'rgba(100,116,139,0.7)', textAlign: 'center' }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div className="lg:hidden" style={{ textAlign: 'center', marginBottom: '2rem' }}>
            ...
            <p style={{ fontSize: '13px', fontWeight: 800, color: 'rgba(255,255,255,0.9)' }}>ProductPRO</p>
          </div>

          <div style={{ marginBottom: '1.75rem' }}>
            <h2 style={{ fontSize: '22px', fontWeight: 900, color: 'white', letterSpacing: '-0.02em', marginBottom: 6 }}>
              로그인
            </h2>
            <p style={{ fontSize: '13px', color: 'rgba(148,163,184,0.75)', fontWeight: 500 }}>
              관리자 계정으로 로그인하세요
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            {/* ID */}
            <div>
              <label style={{ display: 'block', fontSize: '12px', fontWeight: 700, color: 'rgba(148,163,184,0.8)', marginBottom: 6, letterSpacing: '0.05em' }}>
                아이디
              </label>
              <input
                type="text"
            ...
            {error && (
              <div style={{
                ...
                fontSize: '12.5px', fontWeight: 600, color: '#fca5a5',
          ...
          <div style={{ marginTop: '1.25rem', display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            <span style={{ fontSize: '11.5px', fontWeight: 600, color: 'rgba(100,116,139,0.7)', whiteSpace: 'nowrap' }}>계정이 없으신가요?</span>
            <div style={{ flex: 1, height: 1, background: 'rgba(255,255,255,0.07)' }} />
          </div>
          ...
          <Link href="/signup" style={{ textDecoration: 'none', display: 'block', marginTop: '0.75rem' }}>
            <button
              ...
              style={{
                ...
                border: '1px solid rgba(255,255,255,0.12)',
                color: 'rgba(255,255,255,0.85)', fontSize: '13.5px', fontWeight: 700,
                display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8,
                transition: 'all 200ms ease',
                fontFamily: 'inherit',
              }}
          ...
          <div style={{
            ...
            <div>
              <p style={{ fontSize: '11px', fontWeight: 700, color: 'rgba(148,163,184,0.7)', marginBottom: 2 }}>관리자 전용 시스템</p>
              <p style={{ fontSize: '10.5px', color: 'rgba(100,116,139,0.65)', lineHeight: 1.5 }}>
                인가된 계정만 접근할 수 있습니다.
              </p>
            </div>
          </div>
