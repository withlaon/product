...
const STATIC_CATEGORIES: Record<string, Array<{ id: string; name: string }>> = {
  ...
  fashionplus: [
    ...
    // 스포츠
    { id:'FPS001', name:'스포츠 > 스포츠상의' },
    { id:'FPS002', name:'스포츠 > 스포츠하의' },
    { id:'FPS003', name:'스포츠 > 레깅스' },
    { id:'FPS004', name:'스포츠 > 수영복' },
    { id:'FPS005', name:'스포츠 > 스포츠아우터' },
    // 액세서리
    { id:'FPA001', name:'액세서리 > 가방 > 숄더백' },
    { id:'FPA002', name:'액세서리 > 가방 > 크로스백' },
    { id:'FPA003', name:'액세서리 > 가방 > 클러치/파우치' },
    { id:'FPA004', name:'액세서리 > 가방 > 에코백/토트백' },
    { id:'FPA005', name:'액세서리 > 가방 > 백팩' },
    { id:'FPA010', name:'액세서리 > 신발 > 구두/펌프스' },
    { id:'FPA011', name:'액세서리 > 신발 > 샌들/슬리퍼' },
    { id:'FPA012', name:'액세서리 > 신발 > 스니커즈' },
    { id:'FPA013', name:'액세서리 > 신발 > 부츠' },
    { id:'FPA020', name:'액세서리 > 주얼리 > 귀걸이' },
    { id:'FPA021', name:'액세서리 > 주얼리 > 목걸이' },
    { id:'FPA022', name:'액세서리 > 주얼리 > 반지' },
    { id:'FPA023', name:'액세서리 > 주얼리 > 팔찌' },
    { id:'FPA030', name:'액세서리 > 모자' },
    { id:'FPA031', name:'액세서리 > 스카프/숄' },
    { id:'FPA032', name:'액세서리 > 벨트' },
    { id:'FPA033', name:'액세서리 > 선글라스' },
    { id:'FPA034', name:'액세서리 > 양말/스타킹' },
    // 주니어스
    ...
    // 브랜드
    { id:'FPB001', name:'브랜드 > 여성브랜드' },
    { id:'FPB002', name:'브랜드 > 남성브랜드' },
    { id:'FPB003', name:'브랜드 > 스포츠브랜드' },
    // 아웃도어/레저
